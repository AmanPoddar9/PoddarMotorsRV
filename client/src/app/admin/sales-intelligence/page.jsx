...
export default function SalesIntelligencePage() {
  ...
  const handleFileUpload = (event) => {
    ...
    if (file) {
      setRecordedFile(file);
      setAudioPreviewUrl(URL.createObjectURL(file));
      toast.success('File loaded! Click "Analyze" to process.');
    }
  };
              ...
              {!recordedFile && !isProcessing && (
                  <div className="text-center mt-4">
                      ...
                      <label
                          ...
                          className="inline-flex items-center px-4 py-2 bg-white border border-slate-300 rounded-md shadow-sm text-sm font-medium text-slate-700 hover:bg-slate-50 cursor-pointer transition-colors"
                      >
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <a
                      ...
                      className="px-6 py-4 bg-white border-2 border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300 rounded-lg shadow-sm hover:shadow transition-all duration-300 font-bold text-lg flex items-center justify-center space-x-2"
                    >
                      <FaSave className="text-slate-500" />
                      <span>Download</span>
                    </a>

                    <button
                      onClick={handleAnalyze}
                      className="px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-bold text-lg flex items-center justify-center space-x-2"
                    >
