      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-custom-platinum mb-8 text-lg">
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-custom-platinum">{feature.description}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="w-full md:w-1/2 bg-custom-jet p-8 rounded-2xl shadow-xl border border-white/10">
             <div className="bg-workshop-blue/10 p-6 rounded-xl border-2 border-dashed border-workshop-blue/20 text-center">
                <h3 className="text-2xl font-bold text-white mb-2">Why It Matters?</h3>
                <p className="text-custom-platinum mb-6">Using non-genuine parts affects vehicle warranty and safety.</p>
                <div className="flex flex-col gap-3">
                   <div className="flex justify-between items-center bg-custom-black p-3 rounded shadow-sm border-l-4 border-green-500">
                      <span className="font-semibold text-white">Genuine Parts</span>
                      <span className="text-green-600 font-bold text-sm">TESTED FOR SAFETY</span>
                   </div>
                   <div className="flex justify-between items-center bg-custom-black p-3 rounded shadow-sm border-l-4 border-red-500 opacity-60">
                      <span className="font-semibold text-white">Fake Parts</span>
