    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
             <div className="bg-workshop-blue/10 p-6 rounded-xl border-2 border-dashed border-workshop-blue/20 text-center">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Why It Matters?</h3>
                <p className="text-gray-600 mb-6">Using non-genuine parts affects vehicle warranty and safety.</p>
                <div className="flex flex-col gap-3">
                   <div className="flex justify-between items-center bg-white p-3 rounded shadow-sm border-l-4 border-green-500 border border-gray-100">
                      <span className="font-semibold text-gray-900">Genuine Parts</span>
                      <span className="text-green-600 font-bold text-sm">TESTED FOR SAFETY</span>
                   </div>
                   <div className="flex justify-between items-center bg-white p-3 rounded shadow-sm border-l-4 border-red-500 opacity-80 border border-gray-100">
                      <span className="font-semibold text-gray-900">Fake Parts</span>
