...
const BookingForm = () => {
  ...
  return (
    <section id="book-service" className="py-16 md:py-24 bg-white">
      {/* Toast Notification */}
      {showToast && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 text-gray-900 placeholder-gray-400 focus:border-workshop-blue focus:ring-2 focus:ring-workshop-blue/20 outline-none transition-all"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 text-gray-900 focus:border-workshop-blue focus:ring-2 focus:ring-workshop-blue/20 outline-none transition-all"
                  >
