...
const Amenities = () => {
  return (
    <section className="py-16 md:py-24 bg-white overflow-hidden relative border-t border-gray-50">
      {/* Decorative Circles */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-workshop-blue mb-4">Experience Comfort While You Wait</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {amenities.map((item, index) => (
            <div key={index} className="flex flex-col items-center p-6 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-300 group">
